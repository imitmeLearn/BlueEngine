	...
	:name(name)
{
	...
	D3D11_INPUT_ELEMENT_DESC inputDesc[] =
	{
		...
		,{"NORMAL",0,DXGI_FORMAT_R32G32B32_FLOAT,0,32/*24+8*/,D3D11_INPUT_PER_VERTEX_DATA,0}

		,{"TANGENT",0,DXGI_FORMAT_R32G32B32_FLOAT,0,32+(4*3),D3D11_INPUT_PER_VERTEX_DATA,0}
		,{"BITANGENT",0,DXGI_FORMAT_R32G32B32_FLOAT,0,44+(4*3),D3D11_INPUT_PER_VERTEX_DATA,0}
	};
